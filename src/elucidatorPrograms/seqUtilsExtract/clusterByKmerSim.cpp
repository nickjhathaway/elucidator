...
//	uint32_t proposedClusters = std::numeric_limits<uint32_t>::max();
  ...
  hdbScanPars.HDBScountZeroNeighbors = !doNotCountZeroNeighbors;
  ...
  hdbScanPars.numThreads = numThreads;
    ...
    hddbscanRet.initialGroupNames.outPutContents(initialGroupsOut, "\t");

    OutOptions initial_centroidDistancesOutOpts(njh::files::make_path(hdbsDir, "initial_centroidDistances.tab.txt"));
    OutputStream initial_centroidDistancesOut(initial_centroidDistancesOutOpts);
    hddbscanRet.initial_centroidDistances.outPutContents(initial_centroidDistancesOut, "\t");

    OutOptions final_centroidDistancesOutOpts(njh::files::make_path(hdbsDir, "final_centroidDistances.tab.txt"));
    OutputStream final_centroidDistancesOut(final_centroidDistancesOutOpts);
    hddbscanRet.final_centroidDistances.outPutContents(final_centroidDistancesOut, "\t");
...
//		auto sq = static_cast<uint32_t>(std::round(std::sqrt(reads.size())));
