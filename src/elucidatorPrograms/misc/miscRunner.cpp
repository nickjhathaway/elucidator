...
int miscRunner::findTandemMotifLocations(const njh::progutils::CmdArgs & inputCommands){
	std::string motifstr = "";
	//bfs::path genomeFnp = "";
...
int miscRunner::findMotifLocations(const njh::progutils::CmdArgs & inputCommands){
	std::string motifstr = "";
	seqInfo motifObj;
	//bfs::path genomeFnp = "";
	uint32_t allowableErrors = 0;
...
int miscRunner::increaseQualityScores(const njh::progutils::CmdArgs & inputCommands){
