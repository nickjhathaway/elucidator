...
class kmerExpRunner : public njh::progutils::ProgramRunner {
 public:
	...
	static int getBestKmerDetailedKmerDistAgainstRef(const njh::progutils::CmdArgs & inputCommands);
	...
	// static int compressPeptideKmersByScoring(const njh::progutils::CmdArgs & inputCommands);
